...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #1e3a8a; color: white; padding: 5px;">
		<h2>E-commerce</h2>
		<h6>We are trusted by our work</h6>
	...
	<nav class="navbar navbar-default navbar-fixed-top" style="background-color:#1e3a8a; color:#fff;">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Our E-Commerce</a>
			</div>
	...
	%>
	<nav class="navbar navbar-default navbar-fixed-top" style="background-color:#0c4a6e; color:#fff;">
		<div class="container-fluid">
			<div class="navbar-header">
				<button type="button" class="navbar-toggle" data-toggle="collapse"
					data-target="#myNavbar">
